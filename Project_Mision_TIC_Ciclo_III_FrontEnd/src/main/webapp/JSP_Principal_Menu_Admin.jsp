...
<body style="background-image: url(img/F_Cupcake.jpg); background-size: cover;">
	...
	<nav class=" nav justify-content-center bg-primary" style =" width: 80%; margin-left:0; padding: 2% 0 1% 0;">
		...
		<li class="nav-item active"  style="padding: 0 1% 0 1%;">
		<img src="img/Icon_logout.png"><a class="nav-link" href="index.jsp" role="button"
			aria-expanded="false" style="color: #fff; float: right;">Cerrar sesión</a></li>
	</nav>
	</div>
