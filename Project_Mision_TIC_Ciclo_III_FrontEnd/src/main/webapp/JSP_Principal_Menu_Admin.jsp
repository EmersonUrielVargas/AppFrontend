...
<body>
	...
	<nav class=" nav justify-content-center bg-primary" style =" width: 80%; margin-left:0; padding: 2% 0 1% 0;">
		...
		<li class="nav-item "  style="padding: 0 1% 0 1%;">
		<img src="img/home.png"><a class="nav-link active"
			data-bs-toggle="dropdown" href="JSP_Products.jsp" role="button"
			aria-expanded="false" style="color: #fff; float: right;">Productos</a></li>
			
			
		<li class="nav-item "  style="padding: 0 1% 0 1%;">
		<img src="img/home.png"><a class="nav-link active"
			data-bs-toggle="dropdown" href="JSP_Sales.jsp" role="button"
			aria-expanded="false" style="color: #fff; float: right;">Ventas</a></li>
			
			
		<li class="nav-item dropdown"  style="padding: 0 1% 0 1%;">
		<img src="img/home.png"><a class="nav-link dropdown-toggle"
			data-bs-toggle="dropdown" href="#" role="button"
			aria-expanded="false" style="color: #fff; float: right;">Reportes</a>
			<ul class="dropdown-menu bg-primary">
				<li><a class="dropdown-item" style="color: #fff" href="">Listado de Usuarios</a></li>
				<li><a class="dropdown-item" style="color: #fff" href="">Listado de Clientes</a></li>
				<li><a class="dropdown-item" style="color: #fff" href="">Ventas por Usuarios</a></li>
			</ul></li>
