...
<body
	style="background-image: url(img/F_Cupcake.jpg); background-size: cover;">
	<script
	...
	<div
		...
		<nav class=" nav justify-content-center bg-primary"
			style="width: 80%; margin-left: 0; padding: 2% 0 1% 0;">
			<li class="nav-item " style="padding: 0 1% 0 1%;"><img
				src="img/Icon_Home.png"> <a class="nav-link active"
				href="JSP_Principal_Menu_Admin.jsp" role="button"
				aria-expanded="true" style="color: #fff; float: right;">Home</a></li>


			<li class="nav-item dropdown" style="padding: 0 1% 0 1%;"><img
				src="img/Icon_user.png"> <a class="nav-link dropdown-toggle"
			...
			<li class="nav-item dropdown " style="padding: 0 1% 0 1%;"><img
				src="img/Icon_vendor.png"> <a class="nav-link dropdown-toggle"
				data-bs-toggle="dropdown" href="#" role="button"
				aria-expanded="false" style="color: #fff; float: right;">Proveedores</a>
				<ul class="dropdown-menu bg-primary">
					<li><a class="dropdown-item" style="color: #fff"
			...
			<li class="nav-item dropdown " style="padding: 0 1% 0 1%;"><img
				src="img/Icon_client.png"><a class="nav-link dropdown-toggle"
				data-bs-toggle="dropdown" href="#" role="button"
				aria-expanded="false" style="color: #fff; float: right;">Clientes</a>
				<ul class="dropdown-menu bg-primary">
					<li><a class="dropdown-item" style="color: #fff"
			...
			<li class="nav-item " style="padding: 0 1% 0 1%;"><img
				src="img/Icon_products.png"><a class="nav-link active"
				href="JSP_Products.jsp" role="button" aria-expanded="false"
				style="color: #fff; float: right;">Productos</a></li>


			<li class="nav-item " style="padding: 0 1% 0 1%;"><img
				src="img/Icon_sales.png"><a class="nav-link active"
				href="JSP_Sales.jsp" role="button" aria-expanded="false"
				style="color: #fff; float: right;">Ventas</a></li>


			<li class="nav-item dropdown" style="padding: 0 1% 0 1%;"><img
				src="img/Icon_report.png"><a class="nav-link dropdown-toggle"
				data-bs-toggle="dropdown" href="#" role="button"
				aria-expanded="false" style="color: #fff; float: right;">Reportes</a>
				<ul class="dropdown-menu bg-primary">
					<li><a class="dropdown-item" style="color: #fff"
						href="JSP_Report_Users.jsp">Listado de Usuarios</a></li>
					<li><a class="dropdown-item" style="color: #fff"
						href="JSP_Report_Clients.jsp">Listado de Clientes</a></li>
					<li><a class="dropdown-item" style="color: #fff"
						href="JSP_Report_Sales.jsp">Ventas por Usuarios</a></li>
				</ul></li>

			<li class="nav-item " style="padding: 0 1% 0 1%;"><img
				src="img/Icon_logout.png"><a class="nav-link active"
				href="index.jsp" role="button" aria-expanded="false"
				style="color: #fff; float: right;" href="index.jsp">Cerrar
					sesión</a></li>
		</nav>
	</div>
	...
	<div
		style="margin-left: 10%; background-color: #fff; box-shadow: 6px 20px 40px black; width: 80%; margin-top: 5%">
		<div class="row">

			<div class="col-3" align="left" style="width: 600px">
				<img src="img/Vendors.png" width=100%>
			</div>

			<div class="col-6" style="float: right; width: 55%">
				<form method="post" action="./Servlet"
					style="margin-left: 5%; margin-top: 10%; float: right; width: 100%">
					<table style="width: 100%">
						...
						<td><div class="input-group mb-3" style="position: relative;">
								...
								<label><input type="text" required="required"
									name="updateV_vendorAddress" class="form-control"
						...
						<td><div class="input-group mb-3">
								...
								<label><input type="number" required="required"
									name="updateV_vendorEmail" class="form-control" placeholder=""
